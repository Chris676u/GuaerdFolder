...
print(calculateArea(x: 8.6, y: 9.0)!)
...
func createUser()-> User? {
    guard let firstNames = firstNameTextField.text, let lastNames = lastNameTextField.text, let ages = ageTextField.text else{
        return nil
     }
    return User(firstName: firstNames, lastName: lastNames, age: ages)
